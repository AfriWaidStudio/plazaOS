...
export const mockMaintenanceRequests: MaintenanceRequest[] = [
  { id: 'maint-1', tenantId: 'tenant-1', tenantName: 'Jane Cooper', unitId: 'unit-1', unitNumber: 'A-101', title: 'Leaking kitchen faucet', description: 'The faucet has been dripping steadily for two days.', status: 'open', priority: 'medium', category: 'maintenance', images: ['https://placehold.co/640x480?text=Maintenance+Photo'], notes: '', createdAt: '2026-07-29', resolvedAt: null },
  { id: 'maint-2', tenantId: 'tenant-3', tenantName: 'Wade Warren', unitId: 'unit-3', unitNumber: 'B-201', title: 'AC not cooling', description: 'Unit blows warm air, checked filter already.', status: 'in_progress', priority: 'high', category: 'maintenance', images: ['https://placehold.co/640x480?text=Maintenance+Photo'], notes: 'Technician scheduled for Aug 5.', createdAt: '2026-07-25', resolvedAt: null },
  { id: 'maint-3', tenantId: 'tenant-4', tenantName: 'Esther Howard', unitId: 'unit-5', unitNumber: 'B-204', title: 'Broken window latch', description: 'Latch on the west-facing window won’t catch.', status: 'resolved', priority: 'low', category: 'maintenance', images: ['https://placehold.co/640x480?text=Maintenance+Photo'], notes: 'Latch replaced.', createdAt: '2026-07-10', resolvedAt: '2026-07-12' },
  { id: 'maint-4', tenantId: 'tenant-5', tenantName: 'Cameron Williamson', unitId: 'unit-6', unitNumber: 'C-301', title: 'Flickering hallway light', description: 'Light outside the unit flickers intermittently.', status: 'open', priority: 'low', category: 'maintenance', images: ['https://placehold.co/640x480?text=Maintenance+Photo'], notes: '', createdAt: '2026-07-30', resolvedAt: null },
  { id: 'maint-5', tenantId: 'tenant-6', tenantName: 'Guy Hawkins', unitId: 'unit-8', unitNumber: 'C-310', title: 'Clogged drain', description: 'Bathroom sink drains very slowly.', status: 'in_progress', priority: 'medium', category: 'maintenance', images: ['https://placehold.co/640x480?text=Maintenance+Photo'], notes: 'Plumber snaked the drain, monitoring.', createdAt: '2026-07-22', resolvedAt: null },
  { id: 'maint-6', tenantId: 'tenant-2', tenantName: 'Devon Lane', unitId: 'unit-2', unitNumber: 'A-102', title: 'Door lock sticking', description: 'Front door lock is hard to turn, may need lubrication or replacement.', status: 'resolved', priority: 'medium', category: 'maintenance', images: ['https://placehold.co/640x480?text=Maintenance+Photo'], notes: 'Lock lubricated and tested.', createdAt: '2026-07-05', resolvedAt: '2026-07-06' },
]
